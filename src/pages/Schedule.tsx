...
import { Clock, MapPin, User, Wrench, Plus } from 'lucide-react';
import { toast } from 'sonner';

const initialAppointments = [
  { id: 1, title: 'Instalação Split 12000 BTUs', client: 'Carlos Oliveira', date: new Date(), time: '09:00', type: 'Instalação', address: 'Rua das Flores, 123' },
  { id: 2, title: 'Manutenção Preventiva', client: 'Ana Souza', date: new Date(), time: '14:00', type: 'Manutenção', address: 'Av. Paulista, 1000' },
];
